...
export default function UsersAdmin() {
  ...
  const users = getUsers().filter(u => !q || (u.name + u.email + (u.phone || '')).toLowerCase().includes(q.toLowerCase()))
    ...
    <div className="admin-content">
      ...
      <div className="admin-table-wrap glass">
        <table className="admin-table">
          <thead>
            <tr><th>Khách hàng</th><th>SĐT</th><th>Đơn</th><th>Số dư</th><th>Điểm</th><th>Trạng thái</th><th></th></tr>
          </thead>
          <tbody>
            {users.map(u => (
